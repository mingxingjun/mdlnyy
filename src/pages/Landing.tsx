...
const statusConfig = {
  '已完成': { color: '#00D924', bg: 'rgba(0,217,36,0.1)', border: 'rgba(0,217,36,0.2)' },
  '进行中': { color: '#635BFF', bg: 'rgba(99,91,255,0.1)', border: 'rgba(99,91,255,0.2)' },
  '待执行': { color: '#6b7c93', bg: 'rgba(92,95,115,0.1)', border: 'rgba(92,95,115,0.15)' },
};
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#0A2540] font-sans text-[#ffffff] antialiased overflow-x-hidden">

      {/* ═══════════════════════ 1. 导航栏 ═══════════════════════ */}
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-[#0A2540]/70 border-b border-white/[0.06]">
        <div className="max-w-7xl mx-auto flex items-center justify-between h-16 px-6">
          {/* Left: Logo */}
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-[8px] bg-gradient-to-br from-[#635BFF] to-[#7C5CFF] flex items-center justify-center shadow-[0_0_12px_rgba(99,91,255,0.3)]">
              <span className="text-white text-[11px] font-bold tracking-tight">UF</span>
            </div>
            <span className="text-[15px] font-semibold tracking-tight text-[#ffffff]">UniFlow</span>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-8">
            {['功能', '关于', '常见问题'].map((link) => (
              <a
                key={link}
                href={`#${link}`}
                className="text-[13px] text-[#a3b5cc] hover:text-white transition-colors duration-200"
              >
                {link}
              </a>
            ))}
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button
              ...
              className="bg-gradient-to-r from-[#635BFF] to-[#7C5CFF] text-white text-[13px] font-medium rounded-[10px] px-5 py-2 hover:shadow-[0_0_20px_rgba(99,91,255,0.3)] transition-shadow duration-300"
            >
              开始使用
            </button>
          </div>
          ...
          >
            {mobileMenuOpen ? <X size={18} className="text-[#a3b5cc]" /> : <Menu size={18} className="text-[#a3b5cc]" />}
          </button>
        </div>
        ...
        {mobileMenuOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -8 }}
            className="md:hidden bg-[#0A2540]/95 backdrop-blur-xl border border-white/[0.06] rounded-[16px] p-4 mt-2 absolute right-4 top-14 z-50"
          >
            {['功能', '关于', '常见问题'].map((link) => (
              <a
                key={link}
                href={`#${link}`}
                className="block text-[14px] text-[#a3b5cc] hover:text-white transition-colors py-2"
            ...
            <div className="flex gap-3 pt-2 border-t border-white/[0.06] mt-2">
              <button className="text-[13px] text-[#a3b5cc] hover:text-white px-4 py-2">登录</button>
              <button
                onClick={() => navigate('/dashboard')}
                className="bg-gradient-to-r from-[#635BFF] to-[#7C5CFF] text-white text-[13px] font-medium rounded-[10px] px-5 py-2"
              >
                开始使用
              </button>
            </div>
      ...
      <section className="relative pt-20 pb-28 px-6 overflow-hidden">
        {/* Background blobs */}
        <div className="absolute top-0 left-1/4 w-[600px] h-[600px] rounded-full bg-[#635BFF] opacity-[0.15] blur-[120px] pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 relative z-10">
          ...
          >
            <motion.div
              variants={fadeUp}
              custom={0}
              className="inline-flex items-center gap-2 bg-[#0d2d4a] border border-white/[0.06] rounded-full px-3.5 py-1.5 mb-6"
            >
            ...
            <motion.h1
              variants={fadeUp}
              custom={1}
              className="text-[52px] font-bold tracking-tight leading-[1.1] text-[#ffffff] mb-5"
            >
              期末复习，<br />不再一个人硬扛。
            </motion.h1>
            ...
            <motion.div variants={fadeUp} custom={3} className="flex items-center gap-4 flex-wrap">
              <button
                onClick={() => navigate('/dashboard')}
                className="bg-gradient-to-r from-[#635BFF] to-[#7C5CFF] text-white text-[14px] font-medium rounded-[12px] px-8 py-3.5 shadow-[0_4px_16px_rgba(99,91,255,0.3)] hover:shadow-[0_4px_24px_rgba(99,91,255,0.45)] transition-shadow duration-300"
              >
                立即开始复习
              </button>
              <button
                ...
                className="border border-white/[0.1] text-[#a3b5cc] hover:text-white hover:border-[#635BFF]/30 rounded-[12px] px-8 py-3.5 text-[14px] transition-all duration-300"
              >
                查看协作流程 →
              </button>
            </motion.div>
            ...
            {orbitalAgents.map((agent, i) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <div className="bg-[#0d2d4a]/80 backdrop-blur border border-white/[0.06] rounded-[12px] px-3 py-2 flex items-center gap-2 hover:border-[rgba(99,91,255,0.3)] hover:shadow-[0_0_16px_rgba(99,91,255,0.08)] transition-all duration-300 cursor-default min-w-[130px]">
                    <div
                    ...
                    <span className="text-[11px] font-medium text-[#ffffff] whitespace-nowrap">{agent.name}</span>
                  </div>
                </motion.div>
              );
            })}
      ...
      <Section className="py-16 px-6" id="功能">
        <div className="max-w-7xl mx-auto">
          <motion.div variants={fadeUp} className="text-center mb-10">
            <h2 className="text-[32px] font-bold tracking-tight text-[#ffffff] mb-3">核心能力速览</h2>
            <p className="text-[15px] text-[#a3b5cc]">数据驱动的智能复习，效果看得见</p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <motion.div
                ...
                variants={fadeUp}
                custom={i}
                className="bg-[#0d2d4a] border border-white/[0.06] rounded-[24px] p-6 hover:border-[#635BFF]/30 hover:shadow-[0_0_24px_rgba(99,91,255,0.1)] transition-all duration-300 group"
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-[12px] font-medium text-[#00D924] flex items-center gap-0.5">
                    {stat.trendUp && <TrendingUp size={11} />}
                    {stat.trend}
                  </span>
                </div>
                <p className="text-[12px] text-[#6b7c93] mb-1">{stat.label}</p>
                <p className="text-[32px] font-bold tracking-tight text-[#ffffff]">
          ...
          <div className="hidden lg:flex items-start justify-center gap-2">
            {workflowSteps.map((step, i) => (
              <motion.div key={step.name} variants={fadeUp} custom={i} className="flex items-start">
                <div className="bg-[#0d2d4a] border border-white/[0.06] rounded-[20px] p-5 w-[170px] hover:border-[rgba(99,91,255,0.3)] hover:shadow-[0_0_16px_rgba(99,91,255,0.08)] transition-all duration-300 group">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="text-[20px]">{step.emoji}</span>
                    <span className="text-[13px] font-semibold text-[#ffffff]">{step.name}</span>
                  </div>
                  <span
                  ...
                  <p className="text-[11px] text-[#a3b5cc] leading-[1.6]">{step.desc}</p>
                </div>
                {i < workflowSteps.length - 1 && (
                  <div className="flex items-center self-center mx-1">
                    <ChevronRight size={20} className="text-[#6b7c93]" />
                  </div>
                )}
              </motion.div>
            ))}
          ...
          <div className="lg:hidden grid grid-cols-1 md:grid-cols-2 gap-3">
            {workflowSteps.map((step, i) => (
              <motion.div key={step.name} variants={fadeUp} custom={i}>
                <div className="bg-[#0d2d4a] border border-white/[0.06] rounded-[20px] p-5 flex items-start gap-4 hover:border-[rgba(99,91,255,0.3)] transition-all duration-300">
                  <span className="text-[24px] flex-shrink-0">{step.emoji}</span>
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1.5">
                      <span className="text-[14px] font-semibold text-[#ffffff]">{step.name}</span>
                      <span
                    ...
                    <p className="text-[12px] text-[#a3b5cc]">{step.desc}</p>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      <Section className="py-20 px-6" id="常见问题">
        <div className="max-w-7xl mx-auto space-y-24">
          <motion.div variants={fadeUp} className="text-center">
            <h2 className="text-[32px] font-bold tracking-tight text-[#ffffff] mb-3">特色亮点</h2>
            <p className="text-[15px] text-[#a3b5cc]">三大核心能力，让复习更智能</p>
          </motion.div>
          ...
          <motion.div variants={fadeUp} custom={0} className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 max-w-[480px]">
              <div className="inline-flex items-center gap-2 bg-[#635BFF]/10 border border-[rgba(99,91,255,0.2)] rounded-full px-3 py-1 mb-4">
                <GitBranch size={12} className="text-[#635BFF]" />
                <span className="text-[11px] text-[#635BFF] font-medium">知识图谱</span>
              </div>
              <h3 className="text-[28px] font-bold tracking-tight text-[#ffffff] mb-4">概念关联一目了然</h3>
              <p className="text-[15px] text-[#a3b5cc] leading-[1.7]">
                AI 自动构建学科知识图谱，将零散知识点串联成网络。一眼看清概念间的依赖关系，精准定位薄弱环节，让复习不再盲目。
              </p>
            </div>
            <div className="flex-1 max-w-[440px] w-full">
              <div className="bg-[#0d2d4a] border border-white/[0.06] rounded-[20px] p-6 relative overflow-hidden min-h-[300px]">
                {/* Simulated graph visualization */}
                <div className="relative w-full h-[260px]">
                  {/* Central node */}
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    <div className="w-16 h-16 rounded-full bg-[#635BFF]/15 border border-[#635BFF]/30 flex items-center justify-center shadow-[0_0_20px_rgba(99,91,255,0.15)]">
                      <span className="text-[10px] font-medium text-[#635BFF]">微积分</span>
                    </div>
                  </div>
                  {/* Surrounding nodes */}
                  {[
                    ...
                    { label: '积分', x: '85%', y: '58%', color: '#635BFF', size: 'w-13 h-13' },
                    { label: '级数', x: '68%', y: '85%', color: '#FFB800', size: 'w-11 h-11' },
                    { label: '微分方程', x: '12%', y: '75%', color: '#FF3D00', size: 'w-12 h-12' },
                    { label: '多元函数', x: '5%', y: '46%', color: '#00D924', size: 'w-11 h-11' },
                  ].map((node) => (
                    <div
                      key={node.label}
                      className="absolute"
                  ...
                  <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ opacity: 0.15 }}>
                    ...
                    <line x1="50%" y1="50%" x2="89%" y2="62%" stroke="#635BFF" strokeWidth="1" />
                    <line x1="50%" y1="50%" x2="72%" y2="88%" stroke="#FFB800" strokeWidth="1" />
                    <line x1="50%" y1="50%" x2="16%" y2="78%" stroke="#FF3D00" strokeWidth="1" />
                    <line x1="50%" y1="50%" x2="10%" y2="50%" stroke="#00D924" strokeWidth="1" />
                    {/* Cross connections */}
                    <line x1="20%" y1="22%" x2="82%" y2="18%" stroke="#4FD1C5" strokeWidth="0.5" strokeDasharray="4 4" />
                    <line x1="89%" y1="62%" x2="72%" y2="88%" stroke="#FFB800" strokeWidth="0.5" strokeDasharray="4 4" />
                    <line x1="16%" y1="78%" x2="10%" y2="50%" stroke="#00D924" strokeWidth="0.5" strokeDasharray="4 4" />
                  </svg>
                </div>
              </div>
            </div>
          ...
          <motion.div variants={fadeUp} custom={1} className="flex flex-col lg:flex-row-reverse items-center gap-12">
            <div className="flex-1 max-w-[480px]">
              ...
              <h3 className="text-[28px] font-bold tracking-tight text-[#ffffff] mb-4">随时提问，即时解答</h3>
              <p className="text-[15px] text-[#a3b5cc] leading-[1.7]">
                遇到不懂的概念？直接向答疑 Agent 提问。它会结合你的知识图谱和学习进度，给出精准、个性化的解答，还能推荐相关练习题加深理解。
              </p>
            </div>
            <div className="flex-1 max-w-[440px] w-full">
              <div className="bg-[#0d2d4a] border border-white/[0.06] rounded-[20px] p-6 space-y-4">
                {/* Chat bubble: user */}
                <div className="flex justify-end">
                  <div className="bg-[#635BFF]/15 border border-[#635BFF]/20 rounded-[16px] rounded-br-[4px] px-4 py-2.5 max-w-[280px]">
                    <p className="text-[12px] text-[#ffffff]">什么是条件概率？和联合概率有什么区别？</p>
                  </div>
                </div>
                {/* Chat bubble: AI */}
                <div className="flex justify-start">
                  <div className="bg-[#0A2540] border border-white/[0.06] rounded-[16px] rounded-bl-[4px] px-4 py-3 max-w-[320px]">
                    ...
                    <p className="text-[12px] text-[#a3b5cc] leading-[1.6]">
                      条件概率 P(A|B) 是在 B 已发生的前提下 A 发生的概率；联合概率 P(A∩B) 是 A 和 B 同时发生的概率。关系：P(A∩B) = P(A|B) × P(B)
                    </p>
                    <div className="flex items-center gap-2 mt-3">
                      <span className="text-[10px] text-[#635BFF] bg-[#635BFF]/10 px-2 py-0.5 rounded-full">相关练习 →</span>
                      <span className="text-[10px] text-[#4FD1C5] bg-[#4FD1C5]/10 px-2 py-0.5 rounded-full">查看图谱 →</span>
                    </div>
                  </div>
                </div>
                {/* Input bar */}
                <div className="flex items-center gap-2 bg-[#0A2540] border border-white/[0.06] rounded-[12px] px-4 py-2.5">
                  <span className="text-[12px] text-[#6b7c93] flex-1">输入你的问题...</span>
                  <div className="w-7 h-7 rounded-[8px] bg-gradient-to-r from-[#635BFF] to-[#7C5CFF] flex items-center justify-center">
          ...
          <motion.div variants={fadeUp} custom={2} className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 max-w-[480px]">
              ...
              <h3 className="text-[28px] font-bold tracking-tight text-[#ffffff] mb-4">动态调整，精准复习</h3>
              <p className="text-[15px] text-[#a3b5cc] leading-[1.7]">
                计划管理 Agent 根据你的掌握度、遗忘曲线和考试倒计时，动态生成最优复习计划。每天该学什么、学多久，AI 帮你安排得明明白白。
              </p>
            </div>
            <div className="flex-1 max-w-[440px] w-full">
              <div className="bg-[#0d2d4a] border border-white/[0.06] rounded-[20px] p-6">
                <div className="flex items-center justify-between mb-5">
                  <span className="text-[13px] font-semibold text-[#ffffff]">复习计划</span>
                ...
                <div className="relative space-y-0">
                  ...
                  {[
                    ...
                    const dotColor =
                      item.status === 'completed' ? '#00D924'
                      : item.status === 'today' ? '#635BFF'
                      : '#6b7c93';
                    ...
                    return (
                      <div key={item.date + item.task} className="flex items-start gap-3 relative pb-4 last:pb-0">
                        <div className="relative z-10 flex-shrink-0 mt-1">
                          ...
                          />
                          {isToday && (
                            <div className="absolute inset-0 w-[6px] h-[6px] rounded-full bg-[#635BFF] animate-ping opacity-30 mt-[3px]" />
                          )}
                        </div>
                        <div className={`flex-1 rounded-[10px] p-3 ${isToday ? 'bg-[#635BFF]/8 border border-[rgba(99,91,255,0.2)]' : 'bg-[#0A2540] border border-white/[0.04]'}`}>
                          <div className="flex items-center justify-between mb-0.5">
                            <span className="text-[10px] font-medium" style={{ color: dotColor }}>
                              {item.date}
                              {isToday && <span className="ml-1.5 text-[9px] bg-[#635BFF]/15 text-[#635BFF] px-1.5 py-0.5 rounded-[3px]">今天</span>}
                            </span>
                            <Clock size={9} className="text-[#6b7c93]" />
                          </div>
                          <p className={`text-[11px] font-medium ${item.status === 'completed' ? 'text-[#6b7c93] line-through' : 'text-[#ffffff]'}`}>
                            {item.task}
                          </p>
                        </div>
                      </div>
      ...
      <Section className="py-28 px-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] rounded-full bg-[#635BFF] opacity-[0.06] blur-[120px]" />
        ...
        <motion.div variants={fadeUp} className="max-w-2xl mx-auto text-center relative z-10">
          <h2 className="text-[36px] sm:text-[42px] font-bold tracking-tight text-[#ffffff] mb-4 leading-[1.2]">
            把复习从混乱，<br />变成有序。
          </h2>
          <p className="text-[16px] text-[#a3b5cc] leading-[1.7] mb-10 max-w-[460px] mx-auto">
            加入数千名大学生，让多 Agent 帮你掌控期末复习
          </p>
          <button
            onClick={() => navigate('/dashboard')}
            className="bg-gradient-to-r from-[#635BFF] to-[#7C5CFF] text-white text-[15px] font-semibold rounded-[12px] px-9 py-3.5 shadow-[0_4px_16px_rgba(99,91,255,0.3)] hover:shadow-[0_4px_32px_rgba(99,91,255,0.5)] transition-shadow duration-300"
          >
            开始我的期末复习
          </button>
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
              <div className="w-5 h-5 rounded-[6px] bg-gradient-to-br from-[#635BFF] to-[#7C5CFF] flex items-center justify-center">
                <span className="text-white text-[8px] font-bold">UF</span>
              </div>
              <span className="text-[12px] text-[#6b7c93]">UniFlow © 2026</span>
            </div>
            <div className="flex items-center gap-4">
              {['功能', '关于', '文档'].map((link) => (
                <a key={link} href="#" className="text-[12px] text-[#6b7c93] hover:text-[#a3b5cc] transition-colors">
                  {link}
                </a>
              ))}
            </div>
